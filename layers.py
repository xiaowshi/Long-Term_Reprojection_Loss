...
def upsample(x):
    ...
    """
    return F.interpolate(x, scale_factor=2, mode="nearest") #ValueError: align_corners option can only be set with the interpolating modes: linear | bilinear | bicubic | trilinear
